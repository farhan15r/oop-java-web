...
public class PhotographerLogin extends HttpServlet {
  private final Connection conn;

  public PhotographerLogin() throws SQLException {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    String selectQuery = "select * from photographers where " +
        "username = '" + username + "' " +
    ...
    try {
      if (rs.next()) {
        ...
        session.setAttribute("role", "photographers");
