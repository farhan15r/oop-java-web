<%-- 
    Document   : index
    Created on : Sep 26, 2022, 9:25:33 PM
    Author     : nakro
--%>
                    ...
                    <div class="container-fluid px-5">
                        ...
                        <div class="collapse navbar-collapse" id="navbarCollapse">
                            <ul class="navbar-nav me-auto mb-2 mb-md-0">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="#packages">Packages</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <c:choose>
                                ...
                                <c:when test="${role == 'admin'}">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="admins/dashboard">Dashboard</a></li>
                                            <li><hr class="dropdown-divider"></li>
                                            <li><a class="dropdown-item" href="users/logout">Logout</a></li>
                                        </ul>
                                    </div>
                                </c:when>
                                <c:when test="${role == 'photographers'}">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-outline-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                                            <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"></path>
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="photographers/dashboard">Dashboard</a></li>
                                            <li><hr class="dropdown-divider"></li>
                                            <li><a class="dropdown-item" href="users/logout">Logout</a></li>
                                        </ul>
                                    </div>
        ...
        ================================================== -->
            ...
            <section id="gallery">
                <div class="container marketing">
                    ...
                    <h1 class="text-center">Sample Gallery</h1>
                    <br />
